            ...
            <div class="col-lg-11 col-12">
                <div class="row">
                    <div class="col-lg-6 col-12 copywriting">
                        ...
                        <p class="cta">
                            <a href="#checkout" class="btn btn-master btn-primary">
                                Get Started
                            </a>
                        </p>
                    </div>
    ...
    <div class="container">
        <div class="row pb-70">
            ...
            <div class="col-lg-7 col-12">
                <div class="row">
                    <div id="checkout" class="col-lg-6 col-12">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="table-pricing paket-biasa">
                            ...
                            <p>
                                <a href={{route('checkout.create', 'baru-mulai-belajar')}} class="btn btn-master btn-secondary w-100 mt-3">
